...
public class SupabasePasswordLoginRequestJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<SupabasePasswordLoginRequest>() {
  ...
  public override fun toString(): String = buildString(50) {
      append("GeneratedJsonAdapter(").append("SupabasePasswordLoginRequest").append(')') }

  public override fun fromJson(reader: JsonReader): SupabasePasswordLoginRequest {
    ...
    reader.endObject()
    return SupabasePasswordLoginRequest(
  ...
  public override fun toJson(writer: JsonWriter, value_: SupabasePasswordLoginRequest?): Unit {
    if (value_ == null) {
