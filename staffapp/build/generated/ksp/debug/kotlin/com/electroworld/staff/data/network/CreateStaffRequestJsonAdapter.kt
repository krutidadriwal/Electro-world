...
public class CreateStaffRequestJsonAdapter(
  ...
  private val options: JsonReader.Options = JsonReader.Options.of("email", "password", "role")
  ...
  public override fun fromJson(reader: JsonReader): CreateStaffRequest {
  ...
  public override fun toJson(writer: JsonWriter, value_: CreateStaffRequest?): Unit {
    if (value_ == null) {
